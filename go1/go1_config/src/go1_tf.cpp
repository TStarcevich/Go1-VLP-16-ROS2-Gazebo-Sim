...
GO1TFbroadcaster::GO1TFbroadcaster() : Node("go1_tf")
{
    ...
    pose_subscription = this->create_subscription<geometry_msgs::msg::PoseStamped>(*pose_topic, rclcpp::SensorDataQoS(), std::bind(&GO1TFbroadcaster::pose_callback, this, std::placeholders::_1));
}

void GO1TFbroadcaster::pose_callback(const geometry_msgs::msg::PoseStamped::SharedPtr pose)
{

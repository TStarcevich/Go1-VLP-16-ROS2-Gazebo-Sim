...
def generate_launch_description():
    ...
    gz_pkg_share = launch_ros.substitutions.FindPackageShare(package="go1_gazebo").find(
        "go1_gazebo"
    )

    declare_robot_name = DeclareLaunchArgument("robot_name", default_value="go1")
    ...
    pkg_share = launch_ros.substitutions.FindPackageShare(package="go1_config").find("go1_config")
    ...
    default_model_path = os.path.join(pkg_share, "urdf/go1_VLP16.urdf")
    ...
    gazebo_config = os.path.join(launch_ros.substitutions.FindPackageShare(
        package="go1_gazebo"
    ).find("go1_gazebo"), "config/gazebo.yaml")
